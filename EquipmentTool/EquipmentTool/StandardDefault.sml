ABT_S1: 'S1F0' /* Name=AbortTransaction_S1 */
.
AYT: 'S1F1' W /* Name=AreYouThere */
.
OLD: 'S1F2' /* Name=OnlineData */
<L[2]
    <A[8]'ifabSecs'> /* Name=MDLN */
    <A[7]'1.0.0.0'> /* Name=SOFTREV */
>
.
OLD_H: 'S1F2' /* Name=OnlineData_Host */
<L [0]
>
.
SSR: 'S1F3' W /* Name=SelectedEquipmentStatusRequest */
<L[1]
    <U4[1]0> /* Name=SVID */
>
.
SSD: 'S1F4' /* Name=SelectedEquipmentStatusData */
<L [1]
    <B [1] 0x00 > /* Name=SV */
>
.
...
>
.
PRJCE: 'S16F11' W /* Name=PRJobCreateEnh_substrate */
<L [7]
    <U2 [1] 0 >
    <A [0] ''> /* Name=PRJOBID */
    <A [2] '14' > /* Name=MF */
...
>
.
PRJECA: 'S16F12' /* Name=PRJobCrateEnhAcknowledge */
<L [2]
    <A [0] ''> /* Name=PRJOBID */
    <L [2]
        <Boolean [1] True > /* Name=ACKA Mapping=Success */
...
>
.
PRJDC: 'S16F13' W /* Name=PRJobDuplicateCreate_carrier */
<L [5]
    <U2 [1] 0 >
    <L [1]
        <L [3]
...
>
.
PRJDC: 'S16F13' W /* Name=PRJobDuplicateCreate_substrate */
<L [5]
    <U2 [1] 0 >
    <L [1]
        <L [3]
...
>
.
PRJDCA: 'S16F14' /* Name=PRJobDuplicateCrateAcknowledge */
<L [2]
    <L [1]
        <A [0] ''> /* Name=PRJOBID */
    >
...
>
.
PRJMC: 'S16F15' W /* Name=PRJobMultiCreate_carrier */
<L [2]
    <U2 [1] 0 > /* Name=DATAID */
    <L [1]
        <L [6]
...
>
.
PRJMC: 'S16F15' W /* Name=PRJobMultiCreate_substrate */
<L [2]
    <U2 [1] 0 > /* Name=DATAID */
    <L [1]
        <L [6]
...
>
.
PRJDCA: 'S16F16' /* Name=PRJobMultiCrateAcknowledge */
<L [2]
    <L [1]
        <A [0] ''> /* Name=PRJOBID */
    >
...
>
.
PRJD: 'S16F17' W /* Name=PRJobDequeue */
<L [1]
    <A [0] ''> /* Name=PRJOBID */
>
.
PRJDA: 'S16F18' /* Name=PRJobDequeue_Acknowledge */
<L [1]
    <L [2]
        <A [0] ''> /* Name=PRJOBID */
        <L [2]
...
>
.
PRGAO: 'S16F19' W /* Name=PRGetAllObjects */
.
PRGOS: 'S16F20' /* Name=PRGetObjectsSend */
<L [1]
    <L [2]
        <A [0] ''> /* Name=PRJOBID */
        <A [0] ''> /* Name=PRSTATE  */
...
>
.
PRGS: 'S16F21' W /* Name=PRGetSpace */
.
PRGSS: 'S16F22' /* Name=PRGetSpace_Send */
<I2 [0] > /* Name=PRJOBSPACE  */
.
PRJSRV: 'S16F23' W /* Name=PRJobSetRecipeVariable */
<L [2]
    <A [0] ''> /* Name=PRJOBID */
    <L [1]
        <L [2]
...
>
.
PRJSRVA: 'S16F24' /* Name=PRJobSetRecipeVariable_Acknowledge */
<L [2]
    <Boolean [1] True > /* Name=ACKA Mapping=Success */
    <L [1]
        <L [2]
...
>
.
PRJSSM: 'S16F25' W /* Name=PRJobSetStartMethod */
<L [2]
    <L [1]
        <A [0] ''> /* Name=PRJOBID */
    >
...
>
.
PRJSSMA: 'S16F26' /* Name=PRJobSetStartMethod_Acknowledge */
<L [2]
    <L [1]
        <A [0] ''> /* Name=PRJOBID */
    >
...
>
.
CJCR: 'S16F27' W /* Name=ControlJobCommandRequest */
<L [3]
    <A [0] ''> /* Name=CTLJOBID  */
    <I1 [0] > /* Name=CTLJOBCMD  */
    <L [2]
...
>
.
CJCA: 'S16F28' /* Name=ControlJobCommandAcknowledge */
<L [2]
    <Boolean [1] True > /* Name=ACKA Mapping=Success */
    <L [1]
        <L [2]
...
>
.
CJSMO: 'S16F29' W /* Name=PRSetMtrlOrder */
<I1 [0] > /* Name=PRMTRLORDER  */
.
CJSMOA: 'S16F30' /* Name=PRSetMtrlOrder_Acknowledge */
<Boolean [1] True > /* Name=ACKA Mapping=Success */
.
ABT_S17: 'S17F0' /* Name=AbortTransaction_S17 */
.
DRC: 'S17F1' W /* Name=DataReportCreateRequest */
<L [4]
    <U2 [1] 0 >
    <A [0] ''> /* Name=RPTID */
    <A [0] ''> /* Name=DATASRC */
...
>
.
DRCA: 'S17F2' /* Name=DataReportCreateAck */
<L [2]
    <A [0] ''> /* Name=RPTID */
    <I2 [1] 0 > /* Name=ERRCODE Mapping=No error */
>
.
DRD: 'S17F3' W /* Name=DataReportDeleteRequest */
<L [1]
    <A [0] ''> /* Name=RPTID */
>
.
DRDA: 'S17F4' /* Name=DataReportDeleteAck */
<L [2]
    <Boolean [1] True > /* Name=ACKA Mapping=Success */
    <L [1]
        <L [3]
...
>
.
TRC: 'S17F5' W /* Name=TraceCreateRequest */
<L [6]
    <U2 [1] 0 >
    <A [0] ''> /* Name=TRID */
    <Boolean [1] True > /* Name=CEED */
...
>
.
TRCA: 'S17F6' /* Name=TraceCreateAck */
<L [2]
    <A [0] ''> /* Name=TRID */
    <I2 [1] 0 > /* Name=ERRCODE Mapping=No error */
>
.
TRD: 'S17F7' W /* Name=TraceDeleteRequest */
<L [1]
    <A [0] ''> /* Name=TRID */
>
.
TRDA: 'S17F8' /* Name=TraceDeleteAck */
<L [2]
    <Boolean [1] True > /* Name=ACKA Mapping=Success */
    <L [1]
        <L [3]
...
>
.
CELR: 'S17F9' W /* Name=CollectionEventLinkRequest */
<L [4]
    <U2 [1] 0 >
    <A [0] ''> /* Name=EVNTSRC */
    <U2 [1] 0 > /* Name=CEID */
...
>
.
CELA: 'S17F10' /* Name=CollectionEventLinkAck */
<L [3]
    <A [0] ''> /* Name=EVNTSRC */
    <U2 [1] 0 > /* Name=CEID */
    <I2 [1] 0 > /* Name=ERRCODE Mapping=No error */
>
.
CEUR: 'S17F11' W /* Name=CollectionEventUnlinkRequest */
<L [3]
    <A [0] ''> /* Name=EVNTSRC */
    <U2 [1] 0 > /* Name=CEID */
    <A [0] ''> /* Name=RPTID */
>
.
CEUA: 'S17F12' /* Name=CollectionEventUnlinkAck */
<L [4]
    <A [0] ''> /* Name=EVNTSRC */
    <U2 [1] 0 > /* Name=CEID */
    <A [0] ''> /* Name=RPTID */
...
>
.
TRR: 'S17F13' W /* Name=TraceResetRequest */
<L [1]
    <A [0] ''> /* Name=TRID */
>
.
TRRA: 'S17F14' /* Name=TraceReportResetAck */
<L [2]
    <Boolean [1] True > /* Name=ACKA Mapping=Success */
    <L [1]
        <L [3]
...
>
.
ABT_S18: 'S18F0' /* Name=AbortTransaction_S18 */
.
RAR: 'S18F1' W /* Name=ReadAttributeRequest */
<L [2]
    <A [0] ''> /* Name=TARGETID  */
    <L [1]
        <A [0] ''> /* Name=ATTRID  */
...
>
.
RAD: 'S18F2' /* Name=ReadAttributeData */
<L [3]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=SSACK  */
    <L [1]
...
>
.
WAR: 'S18F3' W /* Name=WriteAttributeRequest */
<L [2]
    <A [0] ''> /* Name=TARGETID  */
    <L [1]
        <L [2]
...
>
.
WAA: 'S18F4' /* Name=WriteAttributeAcknowledge */
<L [3]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=SSACK  */
    <L [1]
...
>
.
WDR: 'S18F7' W /* Name=WriteDataRequest */
<L [4]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=DATASEG  */
    <U1 [0] > /* Name=DATALENGTH  */
...
>
.
WDA: 'S18F8' /* Name=WriteDataAcknowledge */
<L [3]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=SSACK  */
    <L [1]
...
>
.
RIR: 'S18F9' W /* Name=ReadIDRequest */
<A [0] ''> /* Name=TARGETID  */
.
RID: 'S18F10' /* Name=ReadIDData */
<L [4]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=SSACK  */
    <A [0] ''> /* Name=MID  */
...
>
.
WIR: 'S18F11' W /* Name=WriteIDRequest */
<L [2]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=MID  */
>
.
WIA: 'S18F12' /* Name=WriteIDAcknowledge */
<L [3]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=SSACK  */
    <L [1]
...
>
.
SCR: 'S18F13' W /* Name=SubsystemCommandRequest */
<L [3]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=SSCMD  */
    <L [1]
...
>
.
SCA: 'S18F14' /* Name=SubsystemCommandAcknowledge */
<L [3]
    <A [0] ''> /* Name=TARGETID  */
    <A [0] ''> /* Name=SSACK  */
    <L [1]
